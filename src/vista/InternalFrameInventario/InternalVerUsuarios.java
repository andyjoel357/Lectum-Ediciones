...
public class InternalVerUsuarios extends javax.swing.JInternalFrame {
    ...
    private void BtnEliminar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEliminar1ActionPerformed
        ...
        int option = JOptionPane.showConfirmDialog(null, "¿Está seguro de eliminar este usuario?","!ADVERTENCIA!",JOptionPane.YES_NO_OPTION);
        if (option == JOptionPane.YES_OPTION) {

            try (Connection conn = Conexion.conectar(); Statement st = conn.createStatement()) {
