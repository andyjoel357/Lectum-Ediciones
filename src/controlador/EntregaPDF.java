...
public class EntregaPDF {
    ...
    public void Datos(int id) {
        ...
        String sql = "select*from cabeceraEntrega where id_detalleCabecera= '" + id + "'";
        Statement st;
    ...
    public void generarPDF() {
        try {
            ...
            fechas.add("NOTA DE ENTREGA: "+numeroF + "\nFecha: " + fecha + "\n\n");
            ...
            for (int i = 0; i < InternalNotaDeEntrega.jTableLibros.getRowCount(); i++) {
                String cantidad = InternalNotaDeEntrega.jTableLibros.getValueAt(i, 1).toString();
                String producto = InternalNotaDeEntrega.jTableLibros.getValueAt(i, 2).toString();
                String precio = InternalNotaDeEntrega.jTableLibros.getValueAt(i, 3).toString();
                String total = InternalNotaDeEntrega.jTableLibros.getValueAt(i, 4).toString();
            ...
            info.add("Descuento: "+ InternalNotaDeEntrega.jTextDescuento.getText()+"%\n\n");
            info.add("Total a pagar: " + InternalNotaDeEntrega.jTextTotal.getText());
